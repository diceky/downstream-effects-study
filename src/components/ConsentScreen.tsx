    ...
    >
      ...
      {role === "writer" ? (
        <>
          ...
          <p style={{ marginBottom: 24 }}>
            作成いただいたメモは、ご所属部署の同僚約3名に共有されます。選定条件として、あなたと同じ部署に所属し、かつAIプロトタイピングプログラムにまだ参加していない方とするため、具体的な人選は八尾さんの補助の元、研究チームが行います。補足資料は同僚に共有されず、メモのみが共有されます。同僚はメモを読み、その解釈についてのアンケートに回答します。同僚の回答内容を、個人が特定できる形であなたに伝わることはありません。
          </p>
