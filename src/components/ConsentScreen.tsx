    ...
    >
      ...
      {role === "writer" ? (
        <>
          ...
          <p style={{ marginBottom: 24 }}>
            メモ作成中は、入力データ(キー入力のログ、執筆中に追加・削除された語句のカウント)及び（該当する場合は）AIへのプロンプト・レスポンスを収集します。メモ作成終了後、本インターフェース上で短い事後アンケートにご回答いただきます。セッション全体の所要時間は<b>約20分</b>を想定しています。
          </p>
          <p style={{ marginBottom: 24 }}>
        ...
        <>
          ...
          <p style={{ marginBottom: 24 }}>
            第1セッションでは、あなたの部署の同僚が作成した1ページのメモをお読みいただきます。この同僚は<b>社内のAIプロトタイピングプログラム</b>に参加し、チームメンバーに向けて主な学びをメモにまとめています。<b>本インターフェース上でまずそのメモを読み、その後、そのメモに対する印象や解釈についてのアンケートにご回答いただきます。</b>メモを読む際には、作成者の名前が提示されます。第1セッションの所要時間は約15分です。
          </p>
          <p style={{ marginBottom: 24 }}>
            第2セッションは第1セッションの2週間後に実施され、<b>メモに関する短いフォローアップアンケートにご回答いただきます。</b>第2セッションの所要時間は約10分です。
          </p>
          <p style={{ marginBottom: 24 }}>
