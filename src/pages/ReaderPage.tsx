      ...
      {step === "immediate_intro" && (
        ...
        >
          ...
          <p style={{ marginBottom: 24 }}>
            本タスクでは、あなたの同僚が作成した短いメモを読んでいただきます。この同僚は社内のAIプロトタイピングプログラムに参加し、そこでの主な学びをチームメンバーに共有するためにメモを作成しました。本インターフェース上でメモを閲覧していただきます。
          </p>
          <p style={{ marginBottom: 24 }}>
            メモは<b>最大5分間</b>表示されます。その間に、メモをよく読んでください。読み終えた段階で先に進んでいただいて構いませんが、メモを閲覧できるのは最長5分間です。5分が経過した後、メモの内容に関するいくつかの質問に回答していただきます。質問に回答している間は、メモを見ることはできません。
          </p>
